...
<div class="container fc">
        <div class="ordercard" >
    <div class="card" style="width: 60rem; padding-bottom:0px; margin-bottom:0px ">
    <i class="fas fa-user-circle icon" style="font-size:6rem; color:black; margin-bottom:0px; padding-bottom:0px"></i>
 ...
 <table  id="tabledata" class=" table table-hover table-bordered" style="padding:0px;">
